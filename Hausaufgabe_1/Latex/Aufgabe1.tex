...
\begin{figure}[H]
    ...
    \caption{Die normalisierte Energy Decay Curve}
    \label{fig:edc}
\end{figure}
...
Aus $IACC_{\mathrm{late}}$ lässt sich hingegen ein Maß für die subjektive Empfindung des vom-Schall eingehüllt-sein ableiten.
